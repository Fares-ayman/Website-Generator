...
def image_com():
    ...
    #finalImg = cv2.resize(finalImg, (640, 480), interpolation=cv2.INTER_LINEAR_EXACT)

    objects = []
    cnt = []
    getcontours(finalImg, imgContour, objects, img, cnt, x_com, y_com, w_com, h_com)
    #elements = objects[::-1]
    #cnt = cnt[::-1]
...
root.geometry("{}x{}+{}+{}".format(1537, 792, -10, 0))  # format(wight, height, start of wight, start of height)
root.resizable(0, 0)
